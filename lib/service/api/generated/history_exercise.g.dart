...
class _HistoryExerciseService implements HistoryExerciseService {
  ...
  @override
  Future<List<ExerciseLast12MonthGetResponse>> getlast12month() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<ExerciseLast12MonthGetResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) =>
            ExerciseLast12MonthGetResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<List<ExerciseSearchByMonthGetResponse>> searchByMonth(
      ExerciseSearchByMonthGetRequest searchByMonth) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(searchByMonth.toJson());
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<ExerciseSearchByMonthGetResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => ExerciseSearchByMonthGetResponse.fromJson(
