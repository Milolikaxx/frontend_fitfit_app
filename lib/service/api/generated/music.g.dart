...
class _MusicService implements MusicService {
  ...
  Future<List<MusicGetResponse>> getSearchMusic(
      SearchMusicGetRequest key) async {
  ...
  @override
  Future<List<MusicGetResponse>> getMusicByWorkoutProfile(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<List<MusicGetResponse>> getMusicForAddSong(
      RandOneSongOfPlaylistRequest key) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<List<MusicGetResponse>> getMusicForAddMusic(
      RandMusic1PostRequest key) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/music/findmusicaddsong/musiclist',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
